...
import 'package:crypto_trends/features/coinInfo/presenter/bloc/coinChartInfo/coininfo_bloc.dart';
...
void main() {
  ...
  final CoinMarketChart coinMarketChart =
      CoinMarketChart(prices: testCoinMarketChart);
  ...
  blocTest<CoinInfoBloc, CoinInfoState>("Should check networkInfo",
      setUp: () {
        whenSuccess();
      },
      build: () => coinInfoBloc,
  ...
  blocTest<CoinInfoBloc, CoinInfoState>(
    ...
    """,
      ...
      expect: () => [
            CoinInfoLoading(),
            CoinInfoLoaded(coinMarketChart: coinMarketChart)
          ]);
  ...
  blocTest<CoinInfoBloc, CoinInfoState>(
    ...
    """,
      ...
      expect: () =>
          [CoinInfoLoading(), const CoinInfoFailure(ErrorType.failedRequest)]);
  blocTest<CoinInfoBloc, CoinInfoState>(
